...
object TuplesAndMaps extends App {
  ...
  val phonebook = Map(("Jim", 555), "Kate" -> 888).withDefaultValue(-1)
  ...
  /*
    ...
    2. Overly simplified social network based on maps
      ...
      - if there isa social connection between two people (direct or not)
   */

  // 1
  val phonebook2 = Map(("Jim", 555), ("JIM", 900))
  println(phonebook2)
  // println(phonebook.map(pair => pair._1.toLowerCase -> pair._2)) // Map(jim -> 9000)
  ...
  println(friend(socialNetwork, "Bob", "Mary"))
  println(unfriend(friend(socialNetwork, "Bob", "Mary"), "Bob", "Mary"))
  println(remove(friend(socialNetwork, "Bob", "Mary"), "Bob"))
  ...
  println(socialConnection(socialNetwork, "Mary", "Bob"))
